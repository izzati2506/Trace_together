...
public class UserBookSlot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_book_slot);
        ...
        ArrayAdapter adapter1 = new ArrayAdapter(UserBookSlot.this,android.R.layout.simple_list_item_1,vac_type);
        ...
        ArrayAdapter adapter2 = new ArrayAdapter(UserBookSlot.this,android.R.layout.simple_list_item_1,vac_location);
        ...
        ArrayAdapter adapter3 = new ArrayAdapter(UserBookSlot.this,android.R.layout.simple_list_item_1,vac_date);
        ...
        ArrayAdapter adapter4 = new ArrayAdapter(UserBookSlot.this,android.R.layout.simple_list_item_1,vac_time);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(vacType.getSelectedItem().toString().equals("Select") || vacType.getSelectedItem().toString().equals("Select") ||
                    ...
                    Toast.makeText(UserBookSlot.this, "Please make selection", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Toast.makeText(UserBookSlot.this, "Data inserted successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(UserBookSlot.this, UserApptPage.class));
                    finish();
                }
